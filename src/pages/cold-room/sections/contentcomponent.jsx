...
import img1 from '../../../assets/images/ac-images/coldroom-installation-london.jpg';
import img5 from '../../../assets/images/ac-images/gurante3.jpg';
        ...
        <div>
                ...
                <Container>
                    <Row className="justify-content-center">
                        <Col md="7" className="text-center">
                            <h2 className="title font-bold" data-aos="fade-down">Installation & Service</h2>
                        </Col>
                    </Row>
                        ...
                        <Col md="7" data-aos="fade-right">
                            <Card>
                                <CardBody className='m-t-30'>
                                    <p className="m-b-10 font-18">We install cold rooms, in any dimensions, for all types of commercial and domestic premises.</p>
            ...
            <div className="spacer">
                <Container>
                    ...
                    <Row className="m-t-40" data-aos="fade-right">
                        <Col md="12">
                            <Card>
                                <CardBody>
                                    <ul className='content-listing'>
