...
import img1 from '../../../assets/images/ac-images/refrigeration-repair.jpg';
import img5 from '../../../assets/images/ac-images/gurante2.jpg';


import Brand1 from '../../../assets/images/ac-images/brand-5.jpg';
import Brand2 from '../../../assets/images/ac-images/brand-6.jpg';
import Brand3 from '../../../assets/images/ac-images/brand-7.jpg';
import Brand4 from '../../../assets/images/ac-images/brand-8.jpg';
                ...
                <Container>
                    <Row className="justify-content-center">
                        <Col md="7" className="text-center" data-aos="fade-up">
                            <h2 className="title font-bold">Installation, Reapir & Maintenance</h2>
                        </Col>
                    </Row>
                    <Row className="m-t-40">
                        <Col md="7" data-aos="fade-right">
                            <Card>
                                <CardBody className='m-t-20'>
                                    <p className="m-b-10 font-18">We install, repair & service refrigeration systems including Cold Rooms, Cellar Coolers, Commercial Fridge , Commercial Freezer, Dairy Display Cabinets etc.</p>
                                    <p className="m-b-10 font-18">We work with all types of commercial premises such as:</p>
                ...
                <Container>
                    <Row className="justify-content-center">
                        <Col md="12" className="text-center">
                            <h2 className="title font-bold" data-aos="fade-down">Brands</h2>
                            <h6 className="subtitle" data-aos="fade-up">
                                We work with well known industry standards such as Williams, Foster, True, Pola, Electrolux etc.
                            </h6>
                        </Col>
                    </Row>
                ...
                <Container>
                    <Row className="justify-content-center">
                        <Col md="7" className="text-center">
                            <h2 className="title font-bold" data-aos="fade-up">Why us</h2>
                        </Col>
                    </Row>
                    <Row className="m-t-40">
                        ...
                        <Col md="6" className="text-left" data-aos="fade-right">
                            ...
                            <CardBody>
                                <ol className='content-listing'>
                                    <li>Call us on 07745 60 40 90</li>
                            ...
                            <Card className="card-shadow">
                                <CardBody>
                                    <div className="p-20">
                                        ...
                                        <p>All electric parts come with one year warranty.</p>
