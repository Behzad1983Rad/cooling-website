                        ...
                        <Col md="7" data-aos="fade-right">
                            <Card>
                                <CardBody className='m-t-30'>
                                    <p className="m-b-10 font-18">Air conditioner installation</p>
                                    <p className="m-b-10 font-18">VRV certified installer</p>
                                    <p className="m-b-10 font-18">Air condition general and deep chemical service</p>
                                    <p className="m-b-10 font-18">Upgrade existing Air condition</p>
                                    <p className="m-b-10 font-18">We install & service Air Condition units, small and large, for all types of commercial and domestic premises.
